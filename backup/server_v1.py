...
# ====== 修改点 1 开始：给1号机注入2号机的初始状态 ======
    ...
    # ====== 修改点 1 继续：给2号机注入1号机的初始状态 ======
    state_1 = drone_states[1]
    info_1 = f"\n\n[TEAMMATE STATUS] Drone 1 is at relative pos (X:{state_1['x']:.2f}, Y:{state_1['y']:.2f}, Z:{state_1['z']:.2f}). Landmarks found: {list(state_1['landmarks'])}."
